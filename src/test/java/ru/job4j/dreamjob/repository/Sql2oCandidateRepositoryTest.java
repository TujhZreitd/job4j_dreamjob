...
class Sql2oCandidateRepositoryTest {
    ...
    public void whenSaveThenGetSame() {
        ...
        var candidate = sql2oCandidateRepository.save(new Candidate(0, "Egor", "description", creationDate, 1, file.getId()));
    ...
    public void whenSaveSeveralThenGetAll() {
        var creationDate = now().truncatedTo(ChronoUnit.MINUTES);
        var candidate1 = sql2oCandidateRepository.save(new Candidate(0, "Egor", "description", creationDate, 1, file.getId()));
        var candidate2 = sql2oCandidateRepository.save(new Candidate(0, "Anton", "description", creationDate, 1, file.getId()));
        var candidate3 = sql2oCandidateRepository.save(new Candidate(0, "Vika", "description", creationDate, 1, file.getId()));
